Feature: check we have all mandatory columns in csv file content and check ohlcv
  ...
  Scenario:
    ...
    And I can use the data processor to obtain an OHLCV series from the tick data
    And the tickData should contain 1 PriceOhlcv objects
  ...
  Scenario:
    Given I have the tickData:
      ...
      | 1694023986.8602	| BTCUSDT	|   Sell  |   0.05	  | 25787.6	  | ZeroMinusTick | 	85022184-7d60-5cf7-8aa3-55d63cc46745	 |    128938000000	  | 0.05	      | 1289.38         |
      | 1694023986.8616	| BTCUSDT	|   Sell  |   0.028	  | 25787.6	  | ZeroMinusTick | 	8f4a6887-ef66-581d-968c-c1542f70bf65	 |    72205280000	  | 0.028	      | 722.0528        |
      | 1694023986.8676	| BTCUSDT	|   Buy   |   0.028	  | 25787.6	  | ZeroMinusTick | 	8f4a6887-ef66-581d-968c-c1542f70bf65	 |    72205280000	  | 0.028	      | 722.0528        |
      | 1694023986.8676	| BTCUSDT	|   Buy   |   0.028	  | 25787.6	  | ZeroMinusTick | 	8f4a6887-ef66-581d-968c-c1542f70bf65	 |    72205280000	  | 0.028	      | 722.0528        |
      | 1694023987.8676	| BTCUSDT	|   Buy   |   0.028	  | 25787.6	  | ZeroMinusTick | 	8f4a6887-ef66-581d-968c-c1542f70bf65	 |    72205280000	  | 0.028	      | 722.0528        |
    Given I extracted the data from "Bybit" exchange and from a csv "file" source
    Then I check the columns
    And I can use the data processor to obtain an OHLCV series from the tick data
    And the tickData should contain 2 PriceOhlcv objects
    And the PriceOhlcv object nb "0" should have the following properties:
    """
    {
      "tsms": 1694023986000,
    ...
    """
    And the PriceOhlcv object nb "1" should have the following properties:
    """
    {
      "tsms": 1694023987000,
      "buyVolume": 0.028,
  ...
  Scenario:
    ...
    Then I check the columns
    And I can use the data processor to obtain an OHLCV series from the tick data
    And the tickData should contain 6 PriceOhlcv objects
    And the PriceOhlcv object nb "0" should have the following properties:
    """
    {
      "tsms": 1694023986000,
    ...
    """
    And the PriceOhlcv object nb "5" should have the following properties:
    """
    {
      "tsms": 1694023991000,
      "open": 25779.6,
